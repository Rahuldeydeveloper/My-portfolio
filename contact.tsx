      ...
      <section id="contact" className="bg-gray-100 py-20">
        ...
        <div className="container mx-auto px-6">
          ...
          <form className="max-w-md mx-auto">
            ...
            <button type="submit" className="w-full bg-blue-600 text-white py-2 px-4 rounded-md font-bold hover:bg-blue-700 transition duration-300">Send Message</button>
          </form>
        </div>
      </section>
    )
